define({ "api": [
  ...
  },
  {
    "type": "get",
    "url": "/companions/:id",
    "title": "Retrieve a single Companion",
    "name": "GetCompanion",
    "group": "Companion",
    "parameter": {
      "fields": {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "name",
            "description": "<p>The Companion's name.</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/companions/:id/serials",
    "title": "Retrieve all serials with a Companion",
    "name": "GetSerialsForCompanion",
    "group": "Companion",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  {
    "type": "get",
    "url": "/serials/:id/companions",
    "title": "Retrieve all Companions of a Serial",
    "name": "GetSerialCompanions",
    "group": "Serial",
    "parameter": {
      "fields": {
        "Parameter": [
